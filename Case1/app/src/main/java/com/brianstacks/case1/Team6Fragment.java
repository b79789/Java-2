 ...
 * {@link Team6Fragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link Team6Fragment#newInstance} factory method to
...
public class Team6Fragment extends Fragment {
     ...
     * @return A new instance of fragment Team6Fragment.
     */
    ...
    public void onActivityCreated(final Bundle _savedInstanceState) {
        ...
        String[] team1 = {" 1B: Brian Stacks"," 2B: Travis Lewis"," 3B: Bobby Shuford",
                " C: Jamie Lewis"," RF: Tony Lewis"," LF: Clint Davis",
                " CF: Alex Shuford"," SS: Rusty Thomas"," P:Jason Guthrie",};
        ArrayAdapter arrayAdapter = new ArrayAdapter(getActivity(),android.R.layout.simple_list_item_1, team1);

        ListView lv =(ListView)getView().findViewById(R.id.list6);

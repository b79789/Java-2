 ...
 * {@link Team4Fragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link Team4Fragment#newInstance} factory method to
...
public class Team4Fragment extends Fragment {
     ...
     * @return A new instance of fragment Team4Fragment.
     */
    ...
    public void onActivityCreated(final Bundle _savedInstanceState) {
        ...
        String[] team1 = {" 1B: Fred Jacks"," 2B: Blake Bortles"," 3B: Ryan Tan",
                " C: Mike Wallae"," RF: Lamar Miller"," LF: Rickey Williams",
                " CF: Ron Brown"," SS: Robert Gruff"," P: Andrew Lucky",};
        ArrayAdapter arrayAdapter = new ArrayAdapter(getActivity(),android.R.layout.simple_list_item_1, team1);

        ListView lv =(ListView)getView().findViewById(R.id.list4);

 ...
 * {@link Team1Fragment.OnFragmentInteractionListener} interface
...
public class Team1Fragment extends Fragment {
    ...
    public void onActivityCreated(final Bundle _savedInstanceState) {
        ...
        String[] team1 = {" 1B: Jack Johnson"," 2B: Brad Ennings"," 3B: Bob Hart",
                " C: Doug Bradley"," RF: Blake Smith"," LF: Zeek Fields",
                " CF: Gary Graves"," SS: Count Blue"," P: Harry Herders",};

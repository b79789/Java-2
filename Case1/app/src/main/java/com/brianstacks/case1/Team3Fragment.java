 ...
 * {@link Team3Fragment.OnFragmentInteractionListener} interface
...
public class Team3Fragment extends Fragment {
    ...
    public void onActivityCreated(final Bundle _savedInstanceState) {
        ...
        String[] team1 = {" 1B: Tom Brady"," 2B: Derrell Revs"," 3B: Antione Gold",
                " C: Blakey Blakes"," RF: Fred Jones"," LF: Carson Palms",
                " CF: Johny Baseball"," SS: Thrower Down"," P: Greg Mad",};
        ArrayAdapter arrayAdapter = new ArrayAdapter(getActivity(),android.R.layout.simple_list_item_1, team1);

        ListView lv =(ListView)getView().findViewById(R.id.list3);

 ...
 * {@link Team5Fragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link Team5Fragment#newInstance} factory method to
...
public class Team5Fragment extends Fragment {
     ...
     * @return A new instance of fragment Team5Fragment.
     */
    ...
    public void onActivityCreated(final Bundle _savedInstanceState) {
        ...
        String[] team1 = {" 1B: Greg Gerard"," 2B: Gerals Blues"," 3B: Grand Enter",
                " C: Jose Altuve"," RF: Jon boy"," LF: Isaiah Smith",
                " CF: Jon Johnny"," SS: Blue Blue"," P: Fast Hurler",};
        ArrayAdapter arrayAdapter = new ArrayAdapter(getActivity(),android.R.layout.simple_list_item_1, team1);

        ListView lv =(ListView)getView().findViewById(R.id.list5);
